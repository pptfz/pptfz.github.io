...
本机做hosts解析，然后浏览器直接访问域名或IP即可，因为这里配置的nginx根目录下只有一个index.php文件，返回结果如下即为成功
...
![iShot2021-06-30 19.12.36](https://gitea.pptfz.cn/pptfz/picgo-images/raw/branch/master/img/iShot2021-06-30 19.12.36.png)
