...
![1582854349472-14314022-835d-495a-b5bd-d3fadebb677d](图解kubernetes Pod创建流程大揭秘.assets/1582854349472-14314022-835d-495a-b5bd-d3fadebb677d.png)

kubelet中的线程模型属于master/wroker模型，通过单master来监听各种事件源，并为每个Pod创建一个goroutine来进行Pod业务逻辑的处理，master和wroker之间通过一个状态管道来进行通信

## 1.2 基于事件驱动的状态最终一致性

![1582854508572-c8e226a6-cf27-4f75-a05b-10a428d1d83b](图解kubernetes Pod创建流程大揭秘.assets/1582854508572-c8e226a6-cf27-4f75-a05b-10a428d1d83b.png)

在通过yaml创建Pod之后，kubernetes会根据当前的事件和当前的Pod状态，来不断进行调整，从而达到最终目标状态的一致性

## 1.3 组件协作流程

![1582855099912-ebbd5d55-50d6-4d60-9064-bedc954d0c47](图解kubernetes Pod创建流程大揭秘.assets/1582855099912-ebbd5d55-50d6-4d60-9064-bedc954d0c47.png)
...
![1582855818264-ebcf6699-d624-41b2-84ed-b63c79b49780](图解kubernetes Pod创建流程大揭秘.assets/1582855818264-ebcf6699-d624-41b2-84ed-b63c79b49780.png)
...
![1582857159762-c71c4f80-4fdf-4e09-8734-b46b479a9c1d](图解kubernetes Pod创建流程大揭秘.assets/1582857159762-c71c4f80-4fdf-4e09-8734-b46b479a9c1d.png)
...
![1582857264537-c598e550-c7a7-4060-9f47-80a191ba3b19](图解kubernetes Pod创建流程大揭秘.assets/1582857264537-c598e550-c7a7-4060-9f47-80a191ba3b19.png)
...
![1582857616380-ec535cdf-9552-4c01-beea-2e689a40add7](图解kubernetes Pod创建流程大揭秘.assets/1582857616380-ec535cdf-9552-4c01-beea-2e689a40add7.png)



kubelet是容器管理的核心大管家，其负责各种准入控制、状态管理、探测管理、volume管理、QOS管理、CSI对接的统一调度，并且为Runtime运行时准备基础的数据和并反馈Pod当前的最新状态

![1582857567030-da703162-0f3b-4cdb-a753-531776aacf9f](图解kubernetes Pod创建流程大揭秘.assets/1582857567030-da703162-0f3b-4cdb-a753-531776aacf9f.png)
