...
![iShot2020-05-2621.40.09](2.rocky版使用命令启动一个实例.assets/iShot2020-05-2621.40.09.png)
...
![iShot2020-05-2709.02.08](2.rocky版使用命令启动一个实例.assets/iShot2020-05-2709.02.08.png)



**解析完后刷新浏览器，会看到默认用户是``cirros``，密码是``gocubsgo``**

![iShot2020-05-2709.03.25](2.rocky版使用命令启动一个实例.assets/iShot2020-05-2709.03.25.png)



**查看主机名、IP地址、检查是否能联网**

![iShot2020-05-2709.18.12](2.rocky版使用命令启动一个实例.assets/iShot2020-05-2709.18.12.png)
