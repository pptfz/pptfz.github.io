...
![1](10.zabbix3.4使用企业微信告警.assets/1.png)
...
![2](10.zabbix3.4使用企业微信告警.assets/2.png)



**应用与小程序-->创建应用，根据提示填写相关信息，这里已经创建好了一个zabbix监控**

![3](10.zabbix3.4使用企业微信告警.assets/3.png)



**点击创建的应用，后续python脚本会用到Agentld和Secret**

![4](10.zabbix3.4使用企业微信告警.assets/4.png)

**点击我的企业，后续python脚本会用到企业ID**

![5](10.zabbix3.4使用企业微信告警.assets/5.png)
...
[root@zabbix-server alertscripts]# ./weixin.py BaiXueBing test test	 
```

**企业微信收到信息即为正确**

![6](10.zabbix3.4使用企业微信告警.assets/6.png)
...
![7](10.zabbix3.4使用企业微信告警.assets/7.png)
...
![8](10.zabbix3.4使用企业微信告警.assets/8.png)
...
![9](10.zabbix3.4使用企业微信告警.assets/9.png)

![9](10.zabbix3.4使用企业微信告警.assets/9-9091623.png)
...
![10](10.zabbix3.4使用企业微信告警.assets/10.png)
...
![11](10.zabbix3.4使用企业微信告警.assets/11.png)
...
![12](10.zabbix3.4使用企业微信告警.assets/12.png)
...
![13](10.zabbix3.4使用企业微信告警.assets/13.png)

**手机端企业微信**

![14](10.zabbix3.4使用企业微信告警.assets/14.png)