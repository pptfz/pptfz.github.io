...
![iShot2020-05-1113.32.19](grep命令.assets/iShot2020-05-1113.32.19.png)



## 1.2扩展正则表达式

![iShot2020-05-1113.32.42](grep命令.assets/iShot2020-05-1113.32.42.png)

## 1.3特殊字字符类

### [:alnum:]		[a-zA-Z0-9]匹配人一个字母或数字字符

![lip_image001](grep命令.assets/lip_image001.png)



### [:alpha:]		匹配任意一个字母（包括大小写）

![lip_image002](grep命令.assets/lip_image002.png)



### [:digit:]		匹配任意一个数字

![lip_image003](grep命令.assets/lip_image003.png)



### [:lower:]		匹配小写字母

![lip_image004](grep命令.assets/lip_image004.png)



### [:upper:]		匹配大写字母

![lip_image005](grep命令.assets/lip_image005.png)



### [:punct:]		匹配标点符号

![clipboar006](grep命令.assets/clipboar006.png)



### [:blank:]		匹配空格与制表符

![clipboar007](grep命令.assets/clipboar007.png)



### [:space:]		匹配一个包括换行符、回车等在内的所有空白字符

![clipboar008](grep命令.assets/clipboar008.png)



### [:graph:]		匹配任意可看的见的且可打印的字符

![clipboar009](grep命令.assets/clipboar009.png)



### [:print:]		匹配任何一个可以打印的字符

![clipboar0010](grep命令.assets/clipboar0010.png)



### [:xdigit:]		匹配任意一个16进制数（0-9，a-f，A-F）

![clipboar0011](grep命令.assets/clipboar0011.png)
...
![c12](grep命令.assets/c12.png)



### -i	比较字符时忽略大小写区别

![c13](grep命令.assets/c13.png)
...
![c24](grep命令.assets/c24.png)

![c25](grep命令.assets/c25.png)
