...
toml-node supports version 0.4.0 the TOML spec as specified by [mojombo/toml@v0.4.0](https://github.com/mojombo/toml/raw/branch/branch/master/versions/en/toml-v0.4.0.md)
