...
* Returns an object with the rendered TOC (on `content`), as well as a `json` property with the raw/branch TOC object, so you can generate your own TOC using templates or however you want
