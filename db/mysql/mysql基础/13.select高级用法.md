...
![sql-join](13.select高级用法.assets/sql-join-5369964.png)
...
![img_innerjoin](13.select高级用法.assets/img_innerjoin.gif)
...
### 2.3.4左外连接	LEFT  JOIN  ON

> **左外连接:从左表返回所有的行(表1),与正确的匹配行(表2)。当没有匹配时，右边的结果为NULL。**

![img_leftjoin](13.select高级用法.assets/img_leftjoin.gif)
...
### 2.3.5右外连接	RIGHT  JOIN  ON

> **右外连接:返回右表(表2)中的所有行，以及左表(表1)中的匹配行。当没有匹配时，左边的结果为NULL。**

![img_rightjoin](13.select高级用法.assets/img_rightjoin.gif)
