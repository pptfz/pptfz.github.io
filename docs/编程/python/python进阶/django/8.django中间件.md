...
![iShot_2024-08-30_16.41.16](https://github.com/pptfz/picgo-images/blob/master/img/iShot_2024-08-30_16.41.16.png)
...
![iShot_2024-08-30_16.43.58](https://github.com/pptfz/picgo-images/blob/master/img/iShot_2024-08-30_16.43.58.png)
...
![iShot_2024-08-30_16.45.06](https://github.com/pptfz/picgo-images/blob/master/img/iShot_2024-08-30_16.45.06.png)
...
![iShot_2024-08-30_16.47.17](https://github.com/pptfz/picgo-images/blob/master/img/iShot_2024-08-30_16.47.17.png)
...
![iShot_2024-08-30_16.48.21](https://github.com/pptfz/picgo-images/blob/master/img/iShot_2024-08-30_16.48.21.png)
...
![iShot_2024-08-30_16.49.33](https://github.com/pptfz/picgo-images/blob/master/img/iShot_2024-08-30_16.49.33.png)
...
![iShot_2024-08-30_16.50.35](https://github.com/pptfz/picgo-images/blob/master/img/iShot_2024-08-30_16.50.35.png)
...
![iShot_2024-08-30_16.52.04](https://github.com/pptfz/picgo-images/blob/master/img/iShot_2024-08-30_16.52.04.png)

## 5.中间件执行流程

**请求到达中间件之后，先按照正序执行每个注册中间件的process_reques方法，process_request方法返回的值是None，就依次执行，如果返回的值是HttpResponse对象，不再执行后面的process_request方法，而是执行当前对应中间件的process_response方法，将HttpResponse对象返回给浏览器。也就是说：如果MIDDLEWARE中注册了6个中间件，执行过程中，第3个中间件返回了一个HttpResponse对象，那么第4,5,6中间件的process_request和process_response方法都不执行，顺序执行3,2,1中间件的process_response方法**

![iShot_2024-08-30_16.53.45](https://github.com/pptfz/picgo-images/blob/master/img/iShot_2024-08-30_16.53.45.png)
...
![iShot_2024-08-30_16.55.46](https://github.com/pptfz/picgo-images/blob/master/img/iShot_2024-08-30_16.55.46.png)
...
![iShot_2024-08-30_16.56.58](https://github.com/pptfz/picgo-images/blob/master/img/iShot_2024-08-30_16.56.58.png)
