...
- 确认一下内核的具体版本 `ls -l /boot`
  ...
  ![iShot_2024-08-22_16.45.15](https://github.com/pptfz/picgo-images/blob/master/img/iShot_2024-08-22_16.45.15.png)
...
![iShot2020-08-0412.07.21](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-0412.07.21.png)
...
- strace 跟踪一下 chroot 的过程，看下丢失的文件。
  ...
  ![iShot2020-08-0412.09.49](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-0412.09.49.png)

- 查看对应文件的关系（测试机补图）。

  ![iShot2020-08-0412.10.23](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-0412.10.23.png)
...
- 确认系统上丢了最终的`libnss_files-2.12.so`，尝试拷贝一个。
  ...
  ![iShot2020-08-0412.11.11](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-0412.11.11.png)

- 此时已经可以上网了，去拷贝一个同版本的文件试试吧。

  ![iShot2020-08-0412.12.44](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-0412.12.44.png)
...
![iShot2020-08-0412.21.52](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-0412.21.52.png)

如果一直等的话，会提示如下截图：

![iShot2020-08-0412.22.25](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-0412.22.25.png)

**原因**

> **/etc/profile 里面有 source /etc/profile 引起死循环，注释即可。**

![iShot2020-08-0412.23.10](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-0412.23.10.png)
...
![iShot2020-08-0510.02.30](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-0510.02.30.png)

登陆系统，使用命令(top 按M)查看内存分配。

![iShot2020-08-0510.04.33](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-0510.04.33.png)

使用命令`free -m`查看内存使用情况

![iShot2020-08-0510.05.17](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-0510.05.17.png)

使用命令`atop`看下内存分配（cat /proc/meminfo 也可以看到一些细化的内存使用信息）。

![iShot2020-08-0510.06.49](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-0510.06.49.png)

发现 cache 才 1.7G，slab 非常高，4.4G，**<span style={{color: 'red'}}>slab 内存简单理解为是系统占用的</span>**。 使用 slabtop 继续分析。

![iShot2020-08-0510.10.52](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-0510.10.52.png)
...
![iShot2020-08-0510.11.49](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-0510.11.49.png)
...
![iShot2020-08-0510.17.07](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-0510.17.07.png)
...
![iShot2020-08-0510.21.08](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-0510.21.08.png)
...
![iShot2020-08-0510.21.46](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-0510.21.46.png)
...
![iShot2020-08-0512.31.17](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-0512.31.17.png)

**解决方法**

> **尝试重启网卡，发现 ifdown ifup 命令不存在：**

![iShot2020-08-0512.32.06](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-0512.32.06.png)
...
![iShot2020-08-0512.34.15](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-0512.34.15.png)
...
![iShot2020-08-0512.35.25-6602152](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-0512.35.25-6602152.png)

**问题分析**

尝试重启 network 服务，发现不行。

![iShot2020-08-0512.36.33](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-0512.36.33.png)



![iShot2020-08-0512.37.12](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-0512.37.12.png)



尝试停止网络服务，然后通过 `ifup eth1` 发现路由是正常的。

![iShot2020-08-0512.39.08](https://github.com/pptfz/picgo-images/blob/master/img/iShot2020-08-