...
| ---------------------------------- | ------------------------------------ | ------------------------------------ | ---------------------------------------- | -------------------------------------- | ---------------------------------- | ---------------------------------- |
| **master**                         | **10.0.0.130**                       | **k8s-master1**                      | **19.03.4**                              | **2c2g**                               | **CentOS7.8**                      | **3.10.0-957.el7.x86_64**          |
| **node1**                          | **10.0.0.131**                       | **k8s-node1**                        | **19.03.4**                              | **2c1g**                               | **CentOS7.8**                      | **3.10.0-957.el7.x86_64**          |
| **node2**                          | **10.0.0.132**                       | **k8s-node2**                        | **19.03.4**                              | **2c1g**                               | **CentOS7.8**                      | **3.10.0-957.el7.x86_64**          |
...
![iShot2020-03-1722.09.59a](https://gitee.com/pptfz/picgo-images/raw/master/img/iShot2020-03-1722.09.59a.png)
