...
![iShot2020-04-0822.39.51](kubectl top命令解析.assets/iShot2020-04-0822.39.51.png)



kubectl top pod: 查看 pod 的使用情况

![iShot2020-04-0822.40.30](kubectl top命令解析.assets/iShot2020-04-0822.40.30.png)



不指定pod 名称，则显示命名空间下所有 pod，–containers可以显示 pod 内所有的container

![iShot2020-04-0822.41.06](kubectl top命令解析.assets/iShot2020-04-0822.41.06.png)
...
![iShot2020-04-0822.41.44](kubectl top命令解析.assets/iShot2020-04-0822.41.44.png)

使用 heapster 时：apiserver 会直接将 metric 请求通过 proxy 的方式转发给集群内的 hepaster 服务。

![iShot2020-04-0822.42.12](kubectl top命令解析.assets/iShot2020-04-0822.42.12.png)

而使用 metrics-server 时：apiserver 是通过 /apis/metrics.k8s.io/ 的地址访问 metric

![iShot2020-04-0822.42.40](kubectl top命令解析.assets/iShot2020-04-0822.42.40.png)

这里可以对比下 kubect get pod 时的日志：

![iShot2020-04-0822.43.16](kubectl top命令解析.assets/iShot2020-04-0822.43.16.png)
...
kube-aggregator 是 apiserver 中的实现，有些 k8s 版本默认没开启，你可以加上这些配置来开启，他的核心功能是**动态注册、发现汇总、安全代理**。![iShot2020-04-0822.44.03](kubectl top命令解析.assets/iShot2020-04-0822.44.03.png)

如 metric-server 注册 pod 和 node 时:

![iShot2020-04-0822.44.39](kubectl top命令解析.assets/iShot2020-04-0822.44.39.png)
...
![iShot2020-04-0822.45.46](kubectl top命令解析.assets/iShot2020-04-0822.45.46.png)
...
![iShot2020-04-0822.46.29](kubectl top命令解析.assets/iShot2020-04-0822.46.29.png)
...
![iShot2020-04-0822.47.01](kubectl top命令解析.assets/iShot2020-04-0822.47.01.png)

核心逻辑是通过 new 出来的 memoryStorage 以及 sysfs 实例，创建一个manager 实例，manager 的 interface 中定义了许多用于获取容器和 machine 信息的函数

![iShot2020-04-0822.49.23](kubectl top命令解析.assets/iShot2020-04-0822.49.23.png)
...
![iShot2020-04-0822.50.02](kubectl top命令解析.assets/iShot2020-04-0822.50.02.png)

如 memory 下的几个常用的指标含义：

![iShot2020-04-0822.50.29](kubectl top命令解析.assets/iShot2020-04-0822.50.29.png)

memory.stat 中的信息是最全的：

![iShot2020-04-0822.50.52](kubectl top命令解析.assets/iShot2020-04-0822.50.52.png)
...
![iShot2020-04-0822.51.33](kubectl top命令解析.assets/iShot2020-04-0822.51.33.png)
...
![iShot2020-04-0822.52.04](kubectl top命令解析.assets/iShot2020-04-0822.52.04.png)
...
![iShot2020-04-0822.52.47](kubectl top命令解析.assets/iShot2020-04-0822.52.47.png)
...
![iShot2020-04-0822.53.19](kubectl top命令解析.assets/iShot2020-04-0822.53.19.png)
